...
function btnClicked() {
    ...
    if (q1 === 1941 && q2.toLowerCase() === "william hanna" && q3.toLowerCase() === "cat" && q4.toLowerCase() === "mouse") {
        document.getElementById("results").innerHTML = "Congrats, Everythings correct";
        document.getElementById("results").style.color = "green";
    } else if (q1 === 1941 && q2.toLowerCase() === "joseph roland barbera" && q3.toLowerCase() === "cat" && q4.toLowerCase() === "mouse") {
        document.getElementById("results").style.color = "green";
        document.getElementById("results").innerHTML = "Congrats, Everythings  correct";
    }
...
if (q4.toLowerCase() === "mouse") {
    ...
    if (q1 !== 1941) {
        ...
        rez1 = 1
        document.getElementById("feedback1").innerHTML = "Tom and Jerry was created in 1941";
        document.getElementById("feedback1").style.color = "red";
    }
    if (q2.toLowerCase() !== "william hanna") {
        console.log("2nd wrong")
        document.getElementById("feedback2").innerHTML = "WRONG!, William Hanna and Joseph Roland Barbera were the creators of Tom and Jerry";
